...
const uint8_t LED_LIST_REDS[] = {LED_ENCODE_RIGHT_TOP_RIGHT, LED_ENCODE_RIGHT_TOP_LEFT};

const uint8_t LED_LIST_YELLOW[] = {LED_ENCODE_CENTRE_TOP_RIGHT, LED_ENCODE_CENTRE_TOP_LEFT};

const uint8_t LED_LIST_BLUE[] = {LED_ENCODE_LEFT_TOP_RIGHT, LED_ENCODE_LEFT_TOP_LEFT};

const uint8_t LED_ALL[] = {LED_ENCODE_RIGHT_TOP_RIGHT, LED_ENCODE_RIGHT_TOP_LEFT, LED_ENCODE_CENTRE_TOP_RIGHT, LED_ENCODE_CENTRE_TOP_LEFT, LED_ENCODE_LEFT_TOP_RIGHT, LED_ENCODE_LEFT_TOP_LEFT};

const uint8_t LED_LIST_FN_1_KEYS[] = {};
